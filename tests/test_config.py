...
def test_example_config_loads() -> None:
    ...
    assert config.sit_to_stand_front_prep_pose is not None
    assert config.sit_to_stand_front_prep_pose.front_right.knee_y == 2148
    ...
    assert config.sit_to_stand_front_prep_pause_ms == 500
    ...
    assert config.sit_to_stand_front_prep_commands() == [
        (1, 2048),
        (2, 2148),
        (3, 2048),
        (4, 2048),
